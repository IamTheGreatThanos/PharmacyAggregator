...
import 'package:pharmacy_aggregator/pages/medication/write_review_search_page.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'package:http/http.dart' as http;
import 'dart:convert';

class MedicationReviewSearch extends StatefulWidget {
  PharmacySearch pharmacy;
  MedicationReviewSearch(this.pharmacy);
  @override
  _MedicationReviewSearchState createState() => _MedicationReviewSearchState();
}

class _MedicationReviewSearchState extends State<MedicationReviewSearch> {
            ...
            children: [
              Padding(
                  ...
                  child: GestureDetector(
                    ...
                    onTap: (){
                      Navigator.push(context, MaterialPageRoute(builder: (context) => WriteReviewSearchPage(widget.pharmacy)));
                    },
                  )
              ),
              Row(
