...
class WriteMedicationReviewPage extends StatefulWidget {
  Medication medication;
  WriteMedicationReviewPage(this.medication);
  @override
  _WriteMedicationReviewPageState createState() => _WriteMedicationReviewPageState();
}

class _WriteMedicationReviewPageState extends State<WriteMedicationReviewPage> {
  var first = false;
  var second = false;
  var third = false;
  var fourth = false;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: buildAppBar(widget.medication.name),
      body: Column(
  ...
  sendReview() async{
    if (rating != 0 && nameController.text != '' && commentController.text != ''){
      ...
      final response = await http.post(AppConstants.baseUrl + "product/create/review/p/",
